...
function Sidebar() {
  ...
  // Деструктуризация данных пользователя (если они есть)
  ...
  // Рендеринг компонента Sidebar
  return (
    <SidebarStyled theme={theme} collapsed={collapsed}>
      {/* Кнопка для сворачивания/разворачивания бокового меню */}
...
// Стилизованный компонент Sidebar
